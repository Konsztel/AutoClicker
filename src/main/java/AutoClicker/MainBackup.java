...
public class Main extends Application implements NativeKeyListener {
    ...
    public void start(Stage primaryStage) {
        ...
        Scene scene1 = new Scene(grid1, 560, 300);
    ...
    private void mouseClick(int czasCzekania) {
    ...
    private void czekaj(int czasCzekania) {
        try {
